...
async function isAdmin(SynPika,jid,sender) {	
	const groupMetadata = citel.isGroup ? await SynPika.groupMetadata(jid).catch((e) => {}) : "";
...
async function isBotAdmin(SynPika,jid,sender) {	
	const groupMetadata = citel.isGroup ? await SynPika.groupMetadata(citel.chat).catch((e) => {}) : "";
			  const participants = citel.isGroup ? await groupMetadata.participants : "";
			  const groupAdminss  = (participants) => {
				admins = []
				for (let i of participants) {
